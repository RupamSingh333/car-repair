...
//echo decryptIt('QmhpbHdhcmFAMTIz');
?>
<html>
  <head>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>TalkIndia</title>
...
<div class="container login-container">
    ...
    <div class="col-sm-5" style="border:0px solid ">
        <div class="login-box">
        <div class="login-logo"> <a href=""><img src="images/footer-logo.png" class="img-responsive center-block"></a> </div>
      </div>
        ...
        <div class="login-box-body" style="padding: 10px;">
            ...
            <div style="font-size: 15px;margin-top: 27px;"><a style="color:#981ca7" target="_blank" href="#">Designed and Developed by Talkindia  © 2022</a></div>
          </div>
      </form>
      </div>
  </div>
