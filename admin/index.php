  ...
  <div class="container login-container">
    <div class="row">
      ...
      <div class="col-sm-5" style="border:0px solid ">
        <div class="login-box">
          <div class="login-logo"> <a href=""><img src="<?php echo SITEPATH; ?>uploads/logo.png" class="img-responsive center-block"></a> </div>
        </div>
        <form class='input-form' action='action/login.php?action=login' method="post" name="form">
          <div class="login-box-body" style="padding: 10px;">
            <h1>Login</h1>
            <p style="color: #0058b4;"><?php echo $_SESSION['msg'];
                                        unset($_SESSION['msg']); ?></p>
            <div class="form-group has-feedback">
              <input name="txt_userId" required type="text" maxlength="50" class="form-control" placeholder="Username">
            ...
            <div style="font-size: 15px;margin-top: 27px;">© 2023 Usicly. All rights reserved. Design by <a href="https://www.codelabsindia.com" target="_blank"> codelabsindia</a></div>
          </div>
        </form>
      </div>
    </div>
