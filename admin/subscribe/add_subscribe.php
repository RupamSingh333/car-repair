    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="box box-info">
          <form id="form" name="form" action="<?php echo SITEPATH; ?>/admin/action/subscribe.php?action=save" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-4 col-lg-4">
                  <div class="form-group">
                    <label>Email</label>
                    <input class="form-control" required name="email" type="text" value="<?php echo $res['email']; ?>" onFocus="txtFocus(this);" onfocusout="txtFocusOut(this);">
                ...
                <a href="<?php echo SITEPATH; ?>/admin/subscribe" class="btn btn-cancel">Cancel</a>
              </div>
            </div>
          </form>
