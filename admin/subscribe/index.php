  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>View All Subscribe </h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo SITEPATH; ?>admin/dashboard.php"><i class="fa fa-dashboard"></i>Home</a></li>


          <li class="active">View All Subscribe</li>
        </ol>
      </section>
      <section class="content">
        ...
        <!-- <div class="button-wrapper ">
          <button onclick="location.href='<?php echo SITEPATH; ?>admin/package/add_package.php'">
            Add Package
          </button>
        </div> -->
                ...
                <tr>
                  ...
                  <?php if ($r['user_type'] == "1") { ?>
                    <td id="font12" width="20%">
                      <a href="<?php echo htmlspecialchars(SITEPATH); ?>admin/action/subscribe.php?action=status&id=<?php echo urlencode(encryptIt($rows['id'])); ?>"
                      ...
                      <a href="<?php echo htmlspecialchars(SITEPATH); ?>admin/subscribe/add_subscribe.php?id=<?php echo urlencode(encryptIt($rows['id'])); ?>"
                      ...
                      <?php if ($per['user']['del'] == 1) { ?>
                        <a href="<?php echo htmlspecialchars(SITEPATH); ?>admin/action/subscribe.php?action=del&id=<?php echo urlencode(encryptIt($rows['id'])); ?>"
            ...
            function confirmDelete(id) {
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  var deleteUrl = "<?php echo SITEPATH; ?>admin/action/subscribe.php?action=del&id=" + id;
