             ...
             <tbody>
               <?php
                ...
                ?>
                 <tr>
                   <td><?php echo $i; ?></td>
                   <td><?php echo $config['banner_type'][$rows['banner_type']]; ?></td>
                   <td><?php echo $rows['banner_name']; ?></td>
                   <td>
                     <a class="iframe" href="javascript:void(0);">
                       <img src="<?php echo SITEPATH; ?>/upload/thumb/<?php echo $rows['banner_img']; ?>" width="50px" height="50px">
                     </a>
                   </td>

                   <td><?php echo date('d-m-Y',strtotime($rows['banner_startfrom'])); ?></td>
