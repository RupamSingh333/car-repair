  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <h1>View All Package </h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo SITEPATH; ?>admin/dashboard.php"><i class="fa fa-dashboard"></i>Home</a></li>


          <li class="active">View All Package</li>
        </ol>
      </section>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo '$' . $rows['package_cost']; ?></td>
                  ...
                  <?php if ($r['user_type'] == "1") { ?>
                    <td id="font12" width="20%">
                      <a href="<?php echo htmlspecialchars(SITEPATH); ?>admin/action/package.php?action=status&id=<?php echo urlencode(encryptIt($rows['id'])); ?>"
                      ...
                      <a href="<?php echo htmlspecialchars(SITEPATH); ?>admin/package/add_package.php?id=<?php echo urlencode(encryptIt($rows['id'])); ?>"
                      ...
                      <?php if ($per['user']['del'] == 1) { ?>
                        <a href="<?php echo htmlspecialchars(SITEPATH); ?>admin/action/package.php?action=del&id=<?php echo urlencode(encryptIt($rows['id'])); ?>"
