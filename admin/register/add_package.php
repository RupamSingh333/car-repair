...
if (isset($_GET['id'])) {
  $name = "Update Register Package";
  $id = decryptIt($_GET['id']);
  $res = getRegPackage_byID($id);
  $st = $res['status'];
} else {
  if ($per['user']['add'] == 0) { ?>
    <script>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="box box-info">
          <form id="form" name="form" action="<?php echo SITEPATH; ?>/admin/action/reg_package.php?action=save" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group">
                    <label> Register Package Name</label>
                    <input class="form-control" required name="name" type="text" value="<?php echo $res['name']; ?>" onFocus="txtFocus(this);" onfocusout="txtFocusOut(this);">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group">
                    <label> Register Package Cost</label>
                    <input class="form-control" required name="amount" type="number" value="<?php echo $res['amount']; ?>" onFocus="txtFocus(this);" onfocusout="txtFocusOut(this);">
                    <label class="label-brdr" style="width: 0%;"></label>
                  </div>
                </div>
                ...
                <a href="<?php echo SITEPATH; ?>/admin/register" class="btn btn-cancel">Cancel</a>
              </div>
            </div>
          </form>
