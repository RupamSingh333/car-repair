...
?>
            <tr>
              <td><?php echo $i; ?></td>
              <td><?php  echo $config['services_type'][$rows['services_type']]; ?></td>
               <td><?php  echo $rows['sort']; ?></td>
              <td ><img src="<?php  echo SITEPATH;?>/upload/thumb/<?php  echo $rows['logo']; ?>" width="80px"  height="50px"></td>
              <td ><img src="<?php  echo SITEPATH;?>/upload/thumb/<?php  echo $rows['icon']; ?>" width="60px"  height="30px"></td>
